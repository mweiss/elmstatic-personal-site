...
header =
    [ div [ class "header" ]
        [ div [ class "header-logo" ]
            [ a [ href "/" ] [ img [ alt "mweiss's blog", src "/img/developer-logo-helper.png", attribute "width" "48" ] [] ]
            , div [ class "header-title" ] [ a [ href "/" ] [ text "Michael Weiss" ] ]
            ]
...
footer =
    div [ class "footer" ]
        [ div [ class "link" ]
            [ githubIcon
            , a [ href "https://github.com/mweiss" ]
                [ text "My GitHub" ]
            ]
        , div [ class "link" ]
